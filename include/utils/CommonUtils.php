 ...
 */
function SaveImage($__FILES, $module, $id, $mode) {
	global $log, $root_directory;
	$log->debug("Entering SaveImage(" . $__FILES . "," . $module . "," . $id . "," . $mode . ") method ...");
	global $adb;
	...
	if ($file_name != "") {
		...
		$move_upload_status = move_uploaded_file($__FILES["imagename"]["tmp_name"], $uploaddir . $image_name_val);
		$image_error = "false";
